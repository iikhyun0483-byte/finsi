...
CREATE TABLE IF NOT EXISTS macro_data (
  ...
  CONSTRAINT valid_indicator CHECK (indicator_type IN ('VIX', 'DXY', 'FEDFUNDS', 'UNRATE', 'CPIAUCSL', 'T10Y2Y'))
);
...
COMMENT ON COLUMN macro_data.indicator_type IS '지표 종류 (VIX, DXY, FEDFUNDS, UNRATE, CPIAUCSL, T10Y2Y)';
