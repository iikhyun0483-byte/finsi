      ...
      <main className="mx-auto max-w-7xl px-6 py-8 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { href: "/disclosure", icon: FileText, label: "📋 공시 피드", desc: "DART Disclosure" },
            { href: "/supply", icon: TrendingUp, label: "💰 수급 추적", desc: "Supply Demand" },
            { href: "/sentiment", icon: Activity, label: "😱 감정 지표", desc: "Market Sentiment" },
            { href: "/trading", icon: Zap, label: "⚡ 실시간 거래", desc: "Live Trading" },
            { href: "/approvals", icon: Activity, label: "✅ 승인 큐", desc: "Approval Queue" },
            { href: "/autopilot", icon: Bot, label: "🤖 Autopilot", desc: "Auto Trading" },
            { href: "/optimization", icon: Settings, label: "⚙️ 자동 최적화", desc: "Auto Optimization" },
            { href: "/ml-signal", icon: Activity, label: "🧠 ML 신호", desc: "ML Signal" },
            { href: "/performance", icon: TrendingUp, label: "📈 성과 리포트", desc: "Performance" },
            { href: "/macro", icon: Globe, label: "🌍 매크로", desc: "Macro Indicators" },
            { href: "/earnings", icon: BarChart3, label: "📊 실적", desc: "Earnings Calendar" },
            { href: "/attribution", icon: Star, label: "🏆 수익 귀속", desc: "Attribution" },
            { href: "/rebalance", icon: TrendingUp, label: "⚖️ 리밸런싱", desc: "Rebalancing" },
            { href: "/positions", icon: Briefcase, label: "💼 포지션", desc: "Position Manager" },
